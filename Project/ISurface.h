...
#include "Inconstructible.h"
	INCONSTRUCTIBLE(IPanel);

	void SetMouseInputEnabled(VPANEL vguiPanel, bool state)
	{
		return Get_vFunction<void(__thiscall*)(void*, VPANEL, bool)>(this, 32)(this, vguiPanel, state);
	}

	const char* GetName(VPANEL vguiPanel)
	{
		return Get_vFunction<const char* (__thiscall*)(void*, VPANEL)>(this, 36)(this, vguiPanel);
	}
};
