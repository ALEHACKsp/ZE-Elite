...
#include "Inconstructible.h"
	INCONSTRUCTIBLE(IInputSystem);

	bool IsButtonDown(int code)
	{
		return Get_vFunction<bool(__thiscall*)(void*, int)>(this, 11)(this, code);
	}

	const char* ButtonCodeToString(int code)
	{
		return Get_vFunction<const char* (__thiscall*)(void*, int)>(this, 27)(this, code);
	}
	...
	int VirtualKeyToButtonCode(int nVirtualKey)
	{
		...
		return Get_vFunction<int(__thiscall*)(void*, int)>(this, 32)(this, nVirtualKey);
	}
